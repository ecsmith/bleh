...
"localhost" != document.location.hostname && (password = prompt("Hi there! This case study is password protected. Please ping me at eric@erchsm.me for the most up-to-date password.", ""), password ? md5(password) == thePassword || (alert("Incorrect Password! Ask me for the password at eric@erchsm.me. Click OK to to return to the home page!"), window.location = "../") : window.location = "../");